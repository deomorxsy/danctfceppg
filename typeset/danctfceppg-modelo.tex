...
% =====================
% as the [ifthen] package last commit was in 2001,
% it was eventually superseded by other packages such as
% etoolbox,  which uses advanced possibilities of eTeX/ε-TeX.
% https://texfaq.org/FAQ-etex
%
% The ε-TeX extensions to TeX are a range of new functionalities
% added by the NTS to Knuth’s original TeX program: see details
% of engine developments for more.
%
% DO NOT: \usepackage{ifthen}
\usepackage{etoolbox}
\usepackage{footnote}
...
% ---
\pagebreak\thispagestyle{empty}\input{./pretextuais/capa}
...
% elemento obrigatório da NBR 14724/2011 (seção 4.2.1.3). Você pode utilizar este modelo até a aprovação
...
\pagebreak\thispagestyle{empty}\input{./pretextuais/dedicatoria}
...
% Epígrafe
% ---
\pagebreak\thispagestyle{empty}\input{./pretextuais/epigrafe}
% ---
...
\pagebreak\thispagestyle{empty}\input{./pretextuais/resumos}
...
\pagebreak\thispagestyle{empty}\input{./pretextuais/siglasesimbolos}
...
% Agradecimentos
% ---
\pagebreak\thispagestyle{empty}\input{./pretextuais/agradecimentos}
% ---
...
\pagebreak\thispagestyle{empty}\input{./conteudo/introducao}
\pagebreak\thispagestyle{empty}\input{./conteudo/fundamentacao}
\pagebreak\thispagestyle{empty}\input{./conteudo/metodologia}
\pagebreak\thispagestyle{empty}\input{./conteudo/resultados}
\pagebreak\thispagestyle{empty}\input{./conteudo/conclusao}
...
% Apêndices e Anexos
% ---
\pagebreak\thispagestyle{empty}\input{./postextuais/apendices}
\pagebreak\thispagestyle{empty}\input{./postextuais/anexos}
